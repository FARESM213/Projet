    ...
    public Profil(Application App, Object P,Suite S) {
        ...
        Fenetre.getModifierButton().addActionListener(e -> {
            if (P.getClass()==Medecin.class) {
                Medecin B= new Medecin(((Medecin) P).Get_id(),Fenetre.getNom(),Fenetre.getLogin(),Fenetre.getMdp(),Fenetre.getSpec(),Fenetre.getEmail());
                try {
                ...
                try {
                    Patient B= new Patient(((Patient) P).Get_id(),Fenetre.getNom(),Fenetre.getLogin(),Fenetre.getMdp(),Fenetre.getEmail());
